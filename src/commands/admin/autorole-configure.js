        ...
        try {
            ...
            if (autoRole) {
                if (autoRole.roleId === targetRoleId) {
                    interaction.editReply("Auto role has already been configurered for that role. To disable, run `/autorole-disable`.");
                    return;
                }
            ...
            console.log(`There has been an error with the /autorole-configure command: ${error}`);
        }
    },
